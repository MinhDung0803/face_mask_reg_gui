...
def face_mask(input_video_list, time_save_videos_folder_list, time_block_video, frame_drop_list,detect_step_list,
              ...
              face_mask_buffer, forward_message, backward_message, wait_stop):
...
def face_mask_dungpm(input_video_list, time_save_videos_folder_list, time_block_video, frame_drop_list,detect_step_list,
    ...
    count_test = 0
    sum_test = 0
    path = "rtsp://admin:Admin123@192.168.111.211/1"
...
def face_mask_run(config_file, face_mask_buffer, forward_message, backward_message, wait_stop):
...
def face_mask_by_threading(config_file, face_mask_buffer, forward_message, backward_message, wait_stop):
